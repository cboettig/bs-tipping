...
```{r plot-simulation, fig.width=3.5, fig.height=6, fig.cap="Simulated time series of adult bass (A0), planktivores (F0), and juvenile bass (J0) over a gradient of harvesting of adult bass (qE)."}
...
```{r plot-dFdt-vs-F, fig.width=3.5, fig.height=3.5, fig.cap="dF/dt vs F. Where the line intersects 0, indicates a value of planktivore abundance that is an equilibrium. Is contingent upon the value of parameters, such as qE. The value of qE used here is the value used for the first time step of the simulation."}
...
```{r plot-dJdt-vs-J, fig.width=3.5, fig.height=3.5, fig.cap="dJ/dt vs J Where the line intersects 0, indicates a value of juvenile bass abundance that is an equilibrium. Is contingent upon the value of parameters, such as qE. The value of qE used here is the value used for the first time step of the simulation."}
# check rate equation ... should be 0 at root
...
```{r plot-dJdt-vs-J-qE, fig.width=3.5, fig.height=3.5, fig.cap="dJ/dt vs J Where the line intersects 0, indicates a value of juvenile bass abundance that is an equilibrium. Is contingent upon the value of parameters, such as qE. Thus, the dJ/dt vs J curve is plotted for several values of qE, providing a visualization of how the stability landscape changes with harvest rate."}
# check rate equation ... should be 0 at root
...
```{r sanity-check1, results='markup'}
...
```{r sanity-check2, results='markup'}
...
```{r sanity-check3, results='markup'}
...
```{r sanity-check4, results='markup'}
...
```{r stabClass, results="markup", eval = FALSE}
...
```{r figure-grow-cons-J, eval=FALSE, fig.width=6, fig.height=6, fig.cap="**Figure.** Growth and consumption curves for juvenile bass (J). Different panels show the curves for varying values of harvest rate on adult bass (qE)."}
